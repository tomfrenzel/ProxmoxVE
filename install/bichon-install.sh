...
fetch_and_deploy_gh_release "bichon" "birdrock00/havanese-bichon-sso" "prebuild" "latest" "/opt/bichon" "bichon-*-$(arch_resolve "x86_64" "aarch64")-unknown-linux-gnu.tar.gz"
